...
class Agent_DQN():
    def __init__(self, numLanes, numCols, numPlants):
        ...
        self.batch_size = 32  
        self.lr = 1e-5  # Reduced to make learning more stable
        self.gamma = 0.99
    ...
    def saveModel(self, episodeNum):
        torch.save(self.q_net.state_dict(), f"/media/vislab-002/SP2 4TB/Jose/Proj4/PlantRewards10MowerPenalty00001Lr/PVZEp{episodeNum}.pth")
