...
class Agent_DQN():
    def __init__(self, numLanes, numCols, numPlants):
        ...
        self.update_target_every = 5000  # Frequency of target network updates
    ...
    def saveModel(self, episodeNum):
        torch.save(self.q_net.state_dict(), f"/home/vislab-001/Documents/Jose/PVZNew/pretrainedModels/Endless5000UpdFreq/PVZEp{episodeNum}.pth")
